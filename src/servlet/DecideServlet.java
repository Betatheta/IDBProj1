...
public class DecideServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			pw.println("<form id=\"decide\" name=\"decideform\" action=\"decideresult\">");

			pw.println("<div class=\"well sidebar-nav\">");
			pw.println("<ul class=\"nav nav-list\">");
			pw.println("<li class=\"nav-header\">Decide on A Plan</li>");
	...
	private void printHeader(PrintWriter pw) {
		...
		pw.println("<title>Plangout | Decide an event</title>");
	...
	private void printRest(PrintWriter pw) {
		...
		pw.println("<button id=\"decbtn\" class=\"btn btn-primary\" onclick=\"vote()\" disabled=\"disabled\">Decide</button>");
		pw.println("</div>");
		pw.println("<script>");
